...
# -*- coding: utf-8 -*-
"""
Created on Wed Jul 22 14:17:06 2020
...
###### Annual maximum sea ice thickness #########
###### Data #########################
#runs A002, B002, D002
#ice_season_002=np.loadtxt('/home/oikkonea/Documents/SmartSea/scenarios/data/coastal_stations/model_results/AnnualMax_H_Kemi_ABD002.txt')
ice_season_002=np.loadtxt('/home/oikkonea/Documents/SmartSea/scenarios/data/AnnualMax_H_Kemi_ABD002.txt')
...
#ice_season_005=np.loadtxt('/home/oikkonea/Documents/SmartSea/scenarios/data/coastal_stations/model_results/AnnualMax_H_Kemi_ABD005.txt')
ice_season_005=np.loadtxt('/home/oikkonea/Documents/SmartSea/scenarios/data/AnnualMax_H_Kemi_ABD005.txt')
#runs A002, B002, D002
...
#hindcast
#HC=np.loadtxt('/home/oikkonea/Documents/SmartSea/scenarios/data/coastal_stations/model_results/AnnualMax_H_Kemi_HC.txt')
HC=np.loadtxt('/home/oikkonea/Documents/SmartSea/scenarios/data/AnnualMax_H_Kemi_HC.txt')
HC_H=HC[:,1]

#observations
Obs=np.loadtxt('/home/oikkonea/Documents/SmartSea/scenarios/data/coastal_stations/observations/Kemi_maxH.csv', delimiter = ",")
Obs_H=Obs[5:,1]/100 #1981->
...
for i in range(8):
    listA=A005[i*10:(i+1)*10]
    listB=B005[i*10:(i+1)*10]
    listD=D005[i*10:(i+1)*10]
...
plt.figure(1),plt.clf() # Plotting: mean, mean+-std, extremes
plt.subplot(1,3,1)

#control period
plt.scatter(x11[:3],ave_002[:3],marker='D',s=60,c='purple')
plt.errorbar(x11[:3],ave_002[:3],yerr=std_002[:3],linestyle=' ',elinewidth=5,color='purple',capsize=3,label='Control period')#box:mean+-std
...
plt.errorbar(x11[3:],ave_002[3:],yerr=std_002[3:],linestyle=' ',elinewidth=5,color='b',capsize=3,label='RCP 4.5')#box:mean+-std
...
plt.errorbar(x12[3:],ave_005[3:],yerr=std_005[3:],linestyle=' ',elinewidth=5,color='r',capsize=3,label='RCP 8.5')#box:mean+-std
...
plt.errorbar(x21,ave_HC,yerr=std_HC,linestyle=' ',elinewidth=5,color='k',capsize=3,label='Reference run')#box:mean+-std
...
plt.errorbar(x22,ave_obs,yerr=std_obs,linestyle=' ',elinewidth=5,color='g',capsize=3,label='Observations')##box:mean+-std
...
plt.ylim(0,1.5)
plt.ylabel('Annual max ice thickness (m)',fontsize=15)
...
###### Data #########################
#runs A002, B002, D002
#ice_season_002=np.loadtxt('/home/oikkonea/Documents/SmartSea/scenarios/data/coastal_stations/model_results/AnnualMax_H_Kalajoki_ABD002.txt')
ice_season_002=np.loadtxt('/home/oikkonea/Documents/SmartSea/scenarios/data/AnnualMax_H_Kalajoki_ABD002.txt')
...
#ice_season_005=np.loadtxt('/home/oikkonea/Documents/SmartSea/scenarios/data/coastal_stations/model_results/AnnualMax_H_Kalajoki_ABD005.txt')
ice_season_005=np.loadtxt('/home/oikkonea/Documents/SmartSea/scenarios/data/AnnualMax_H_Kalajoki_ABD005.txt')
...
#hindcast
#HC=np.loadtxt('/home/oikkonea/Documents/SmartSea/scenarios/data/coastal_stations/model_results/AnnualMax_H_Kalajoki_HC.txt')
HC=np.loadtxt('/home/oikkonea/Documents/SmartSea/scenarios/data/AnnualMax_H_Kalajoki_HC.txt')
HC_H=HC[:,1]

#observations
Obs=np.loadtxt('/home/oikkonea/Documents/SmartSea/scenarios/data/coastal_stations/observations/Kalajoki_maxH.csv', delimiter = ",")
Obs_H=Obs[:,1]/100 #1991->
...
for i in range(8):
    ...
    data_002[i]=np.hstack((listA,listB,listD))
    min_002[i]=(np.min(listA)+np.min(listB)+np.min(listD))/3
    max_002[i]=(np.max(listA)+np.max(listB)+np.max(listD))/3
    ave_002[i]=(np.mean(listA)+np.mean(listB)+np.mean(listD))/3
    med_002[i]=np.median(data_002[i])
    std_002[i]=(np.std(listA)+np.std(listB)+np.std(listD))/3
...
for i in range(3):
    ...
    p25_HC[i]=med_HC[i]-np.percentile(data_HC[i],25) #The range where 50 % of values fall in. For plotting, the difference between median and upper/lower limit is needed
    p75_HC[i]=np.percentile(data_HC[i],75)-med_HC[i]
#    print('kalajoki ave,med,25,75',ave_HC[i],med_HC[i],np.percentile(data_HC[i],25),np.percentile(data_HC[i],75))
...
###### Data #########################
#runs A002, B002, D002
#ice_season_002=np.loadtxt('/home/oikkonea/Documents/SmartSea/scenarios/data/coastal_stations/model_results/AnnualMax_H_Salgrund_ABD002.txt')
ice_season_002=np.loadtxt('/home/oikkonea/Documents/SmartSea/scenarios/data/AnnualMax_H_Salgrund_ABD002.txt')
...
#ice_season_005=np.loadtxt('/home/oikkonea/Documents/SmartSea/scenarios/data/coastal_stations/model_results/AnnualMax_H_Salgrund_ABD005.txt')
ice_season_005=np.loadtxt('/home/oikkonea/Documents/SmartSea/scenarios/data/AnnualMax_H_Salgrund_ABD005.txt')
...
#hindcast
#HC=np.loadtxt('/home/oikkonea/Documents/SmartSea/scenarios/data/coastal_stations/model_results/AnnualMax_H_Salgrund_HC.txt')
HC=np.loadtxt('/home/oikkonea/Documents/SmartSea/scenarios/data/AnnualMax_H_Salgrund_HC.txt')
HC_H=HC[:,1]

#observations
Obs=np.loadtxt('/home/oikkonea/Documents/SmartSea/scenarios/data/coastal_stations/observations/Sälgrund_maxH.csv', delimiter = ",")
Obs_H=Obs[:,1]/100 #1991->
...
for i in range(8):
    ...
    upper_002[i]=max_002[i]-ave_002[i]
    lower_002[i]=ave_002[i]-min_002[i] #for plotting, the difference between mean and min/max is needed
...
plt.errorbar(x21,ave_HC,yerr=std_HC,linestyle=' ',elinewidth=5,color='k',capsize=3,label='Reference run')
plt.errorbar(x21,ave_HC,yerr=extremes_HC,linestyle=' ',elinewidth=1.2,color='k',capsize=3,)
plt.scatter(x22[:2],ave_obs[:2],marker='D',s=60,c='g')
plt.errorbar(x22[:2],ave_obs[:2],yerr=std_obs[:2],linestyle=' ',elinewidth=5,color='g',capsize=3,label='Observations')
plt.errorbar(x22[:2],ave_obs[:2],yerr=extremes_obs[:,:2],linestyle=' ',elinewidth=1.2,color='g',capsize=3,)
plt.grid('on')
...
plt.errorbar(x21,med_HC,yerr=extremes_HC2,linestyle=' ',elinewidth=1.2,color='k',capsize=3)
#observations
plt.scatter(x22[:2],med_obs[:2],marker='D',s=60,c='g')
plt.errorbar(x22[:2],med_obs[:2],yerr=p25_75_obs[:,:2],linestyle=' ',elinewidth=5,color='g',capsize=3,label='Observations')#box:50 % of values
plt.errorbar(x22[:2],med_obs[:2],yerr=extremes_obs2[:,:2],linestyle=' ',elinewidth=1.2,color='g',capsize=3)  
plt.grid('on')
plt.title('Sälgrund',fontsize=17)
plt.legend(ncol=1,fontsize=13)
plt.ylim(0,1.5)
